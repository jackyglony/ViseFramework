...
import com.vise.ble.callback.IBleCallback;
import com.vise.ble.callback.IConnectCallback;
import com.vise.ble.callback.scan.PeriodLScanCallback;
import com.vise.ble.callback.scan.PeriodMacScanCallback;
import com.vise.ble.callback.scan.PeriodNameScanCallback;
import com.vise.ble.callback.scan.PeriodScanCallback;
import com.vise.ble.common.BleConstant;
import com.vise.ble.common.State;
...
import com.vise.ble.model.BluetoothLeDevice;
import com.vise.log.ViseLog;
import com.vise.ble.utils.HexUtil;
...
public class ViseBluetooth {
    ...
    public boolean writeCharacteristic(BluetoothGattCharacteristic characteristic, byte[] data,
        ...
        ViseLog.i(characteristic.getUuid() + " characteristic write bytes: "
    ...
    public boolean writeDescriptor(BluetoothGattDescriptor descriptor, byte[] data, final IBleCallback<BluetoothGattDescriptor> bleCallback) {
        ...
        ViseLog.i(descriptor.getUuid() + " descriptor write bytes: "
                + Arrays.toString(data) + " ,hex: " + HexUtil.encodeHexStr(data));
